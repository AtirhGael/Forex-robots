...
static input int    Magic_Number = 1389317953; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       83; // Stop Loss   (pips)
       input int    Take_Profit  =       89; // Take Profit (pips)

static input string ___0______   = "------"; // --- Stochastic ---
       input int    Ind0Param0   =       11; // %K Period
       input int    Ind0Param1   =        8; // %D Period
       input int    Ind0Param2   =        9; // Slowing
       input double Ind0Param3   =     31.0; // Level
...
static input string ___2______   = "------"; // --- Envelopes ---
       input int    Ind2Param0   =       32; // Period
       input double Ind2Param1   =     0.64; // Deviation %
...
static input string News_Currencies   = "GBP,JPY,USD"; // News currencies
...
void ManageClose(void)
  {
   // Envelopes (Close, Simple, 32, 0.64)
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET BlackBull; GBPJPY; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":83,"takeProfit":89,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Stochastic","listIndexes":[4,0,0,0,0],"numValues":[11,8,9,31,0,0]},{"name":"Bulls Power","listIndexes":[2,0,0,0,0],"numValues":[23,0,0,0,0,0]}],"closeFilters":[{"name":"Envelopes","listIndexes":[2,3,0,0,0],"numValues":[32,0.64,0,0,0,0]}]} */
