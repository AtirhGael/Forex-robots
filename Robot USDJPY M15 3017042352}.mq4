...
static input string ___2______   = "------"; // --- MACD ---
       input int    Ind2Param0   =        5; // Fast EMA
       input int    Ind2Param1   =        8; // Slow EMA
       input int    Ind2Param2   =        9; // MACD SMA

static input string ___3______   = "------"; // --- Candle Color ---
       input int    Ind3Param0   =       44; // Min body height [pips]
       input int    Ind3Param1   =        3; // Consecutive candles
...
int GetEntrySignal(void)
  {
   ...
   // Bears Power (30)
   double ind1val1  = iBearsPower(NULL, 0, Ind1Param0, PRICE_CLOSE, 1);
   double ind1val2  = iBearsPower(NULL, 0, Ind1Param0, PRICE_CLOSE, 2);
...
void ManageClose(void)
  {
   ...
   bool ind3short = false;
   {
      ...
      ind3long  = consecutiveBullish >= Ind3Param1;
      ind3short = consecutiveBearish >= Ind3Param1;
   }
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET BlackBull; USDJPY; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":74,"takeProfit":78,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[8,1,0,0,0,0]},{"name":"Bears Power","listIndexes":[1,0,0,0,0],"numValues":[30,0,0,0,0,0]},{"name":"MACD","listIndexes":[2,3,0,0,0],"numValues":[5,8,9,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[44,3,0,0,0,0]}]} */
