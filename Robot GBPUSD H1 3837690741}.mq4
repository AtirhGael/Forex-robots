...
static input int    Magic_Number = 1918845371; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       82; // Stop Loss   (pips)
       input int    Take_Profit  =       86; // Take Profit (pips)

static input string ___0______   = "------"; // --- Bollinger Bands ---
       input int    Ind0Param0   =       13; // Period
       input double Ind0Param1   =     1.86; // Deviation

static input string ___1______   = "------"; // --- Stochastic ---
       input int    Ind1Param0   =       10; // %K Period
       input int    Ind1Param1   =        5; // %D Period
       input int    Ind1Param2   =        2; // Slowing
       input double Ind1Param3   =     50.0; // Level

static input string ___2______   = "------"; // --- Candle Color ---
       input int    Ind2Param0   =       33; // Min body height [pips]
       input int    Ind2Param1   =        5; // Consecutive candles
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET BlackBull; GBPUSD; H1 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":82,"takeProfit":86,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Bollinger Bands","listIndexes":[4,3,0,0,0],"numValues":[13,1.86,0,0,0,0]},{"name":"Stochastic","listIndexes":[1,0,0,0,0],"numValues":[10,5,2,50,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[1,0,0,0,0],"numValues":[33,5,0,0,0,0]}]} */
