...
static input int    Magic_Number = 1827096590; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       80; // Stop Loss   (pips)
       input int    Take_Profit  =       99; // Take Profit (pips)

static input string ___0______   = "------"; // --- Stochastic ---
       input int    Ind0Param0   =       14; // %K Period
       input int    Ind0Param1   =        8; // %D Period
       input int    Ind0Param2   =       10; // Slowing
       input double Ind0Param3   =     37.0; // Level

static input string ___1______   = "------"; // --- Moving Averages Crossover ---
       input int    Ind1Param0   =       11; // Fast MA period
       input int    Ind1Param1   =       34; // Slow MA period

static input string ___2______   = "------"; // --- Average True Range ---
       input int    Ind2Param0   =       23; // Period
       input double Ind2Param1   =   0.0065; // Level
...
static input string News_Currencies   = "GBP,USD"; // News currencies
...
int GetEntrySignal(void)
  {
   // Stochastic (14, 8, 10), Level: 37.0
   double ind0val1  = iStochastic(NULL, 0, Ind0Param0, Ind0Param1, Ind0Param2, MODE_SMA, STO_LOWHIGH, MODE_MAIN, 1);
   double ind0val2  = iStochastic(NULL, 0, Ind0Param0, Ind0Param1, Ind0Param2, MODE_SMA, STO_LOWHIGH, MODE_MAIN, 2);
   bool   ind0long  = ind0val1 < Ind0Param3 - sigma && ind0val2 > Ind0Param3 + sigma;
   bool   ind0short = ind0val1 > 100 - Ind0Param3 + sigma && ind0val2 < 100 - Ind0Param3 - sigma;

   // Moving Averages Crossover (Simple, Simple, 11, 34)
...
void ManageClose(void)
  {
   // Average True Range (23), Level: 0.0065
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET BlackBull; GBPUSD; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":80,"takeProfit":99,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Stochastic","listIndexes":[5,0,0,0,0],"numValues":[14,8,10,37,0,0]},{"name":"Moving Averages Crossover","listIndexes":[3,0,0,0,0],"numValues":[11,34,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[2,0,0,0,0],"numValues":[23,0.0065,0,0,0,0]}]} */
