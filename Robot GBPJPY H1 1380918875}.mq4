...
static input int    Magic_Number = 1380918875; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       84; // Stop Loss   (pips)
...
static input string ___1______   = "------"; // --- Bulls Power ---
       input int    Ind1Param0   =       19; // Period
...
int GetEntrySignal(void)
  {
   ...
   double ind0val3  = iMA(NULL, 0, Ind0Param0, Ind0Param1, MODE_SMA, PRICE_CLOSE, 3);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET BlackBull; GBPJPY; H1 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":84,"takeProfit":99,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[7,0,3,0,0],"numValues":[21,0,0,0,0,0]},{"name":"Bulls Power","listIndexes":[2,0,0,0,0],"numValues":[19,0,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[36,3,0,0,0,0]}]} */
